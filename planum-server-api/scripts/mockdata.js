...
var gameIds = buildObjectIdArray(1);
var playerIds = buildObjectIdArray(6);
...
var songIds = buildObjectIdArray(8);
...
db.players.save({ _id: playerIds[0], name: "jorge", thumbLink: "/img/players/jorge.jpg", activeGame: gameIds[0], games: [gameIds[0]], oauthuser: playerIds[0] });
db.players.save({ _id: playerIds[1], name: "cralos", thumbLink: "/img/players/carlos.jpg", activeGame: gameIds[0], games: [gameIds[0]], oauthuser: playerIds[1] });
db.players.save({ _id: playerIds[2], name: "nachoman", thumbLink: "/img/players/nacho.jpg", activeGame: gameIds[0], games: [gameIds[0]], oauthuser: playerIds[2] });
db.players.save({ _id: playerIds[3], name: "flensel", thumbLink: "/img/players/alfonso.jpg", activeGame: gameIds[0], games: [gameIds[0]], oauthuser: playerIds[3] });
db.players.save({ _id: playerIds[4], name: "berny", thumbLink: "/img/players/berny.jpg", activeGame: gameIds[0], games: [gameIds[0]], oauthuser: playerIds[4] });
db.players.save({ _id: playerIds[5], name: "pablo", thumbLink: "/img/players/pablo.jpg", activeGame: gameIds[0], games: [gameIds[0]], oauthuser: playerIds[5] });
...
db.votes.save({ _id: voteIds[5], comment: "HEILD", player: playerIds[5], publication: publicationIds[0], tags: [tagIds[3]], date: new Date('Jul 19, 2014') });
...
db.songs.save({ _id: songIds[2], artist: 'Chamillionaire', name: 'Ridin\' Dirty', youtubeId: '9nf4DhXy9oU' });
...
db.songs.save({ _id: songIds[6], artist: 'Feed Me & Crystal Fighters', name: 'Love Is All I Got', youtubeId: 'hicCHaC_z5I' });
db.songs.save({ _id: songIds[7], artist: 'Opeth', name: 'In my time of need', youtubeId: '9x6YclsLHN0' });

db.songqueues.save({ player: playerIds[0], songs: [songIds[0], songIds[1]] });
db.songqueues.save({ player: playerIds[1], songs: [songIds[0], songIds[1]] });
db.songqueues.save({ player: playerIds[2], songs: [songIds[0], songIds[1]] });
db.songqueues.save({ player: playerIds[3], songs: [songIds[0], songIds[1]] });
db.songqueues.save({ player: playerIds[4], songs: [songIds[0], songIds[1]] });
db.songqueues.save({ player: playerIds[5], songs: [songIds[0], songIds[1]] });

// db.songqueues.save({ player: playerIds[0], songs: [] });
// db.songqueues.save({ player: playerIds[1], songs: [] });
// db.songqueues.save({ player: playerIds[2], songs: [] });
// db.songqueues.save({ player: playerIds[3], songs: [] });
// db.songqueues.save({ player: playerIds[4], songs: [] });
// db.songqueues.save({ player: playerIds[5], songs: [] });
...
db.oauthusers.save({ _id: playerIds[4], username: "berny", password: "password", firstname: "Berny", lastname: "", email: "gugeoage@gmail.com", admin: false });
db.oauthusers.save({ _id: playerIds[5], username: "hitler", password: "password", firstname: "Hitler", lastname: "", email: "gugeoage@gmail.com", admin: true });
